...
<div id="container">
 <div id="header">
   <h1 align="center"><img src="../IMAGES/banner.jpg" width="848" height="100" align="middle" />
     <!-- end #header -->
   </h1>
  </div>
  <div id="sidebar1">
  ...
  <!-- end #sidebar2 --></div>
  <div id="mainContent">
    <h1><span class="content">Welcome to RTLSA Rubbers!<br />
      <br />
&nbsp;RTL SA is a rubber-related products based  company which produces customized products for their customers based on their  &nbsp;requirements, which ranges from rubber compounds to moulded rubber products.  Their customers include the rubber &nbsp;manufacturing industries, rubber products  industries and also other industries.</span></h1>
    <!-- end #mainContent --></div>
